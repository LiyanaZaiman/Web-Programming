...
$insert_sql = "INSERt INTO user VALUES('$id', '$username', '$password', '$fname', '$lname', '$phoneno', '$gender', '$age', '$email', '$category')";	
...
?>
	<h2><a href="playerlogin.html" class="yellow">Login Here</a><h2>
	</div>
		</section>
