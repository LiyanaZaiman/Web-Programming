...
<html>
	<head>
		...
		<title> Youth Archery Tournament | Player Profile</title>
	...
	<body>
		<header>
			...
			<nav>
				<ul>
					<li><a class="current" href="playerprofile.php">Profile Details</a></li>
					<li><a href="playerMainMenu.html">Main Menu</a></li>
